			...
			case 'bookEditionsLanguage':
				...
				.append(
					...
					.click(function(){
						...
						_bookEditionsLanguage(allEditions.attr('href'),'Italian');
					})
				);
...
/*TODO
label in lingua
	caricare la lingua di defualt dal browser
...
*/
		...
		$(document).ready(function(){
			...
			//OPTIONS
			options=$('<div/>',{
				'class':'samoOptions gr-notifications gr-box gr-box gr-box--forceScrollBar'
			})
			...
			if (_bookTitle.length){
				pageType='BOOK PAGE';
				options
				.append(_menuOptionsButton('bookEditionsLanguage'));
/*TODO
			filtrare reviews in italiano
				di libri in edizione italiana
				di utenti che hanno come lingua preferita italiano?
*/
			...
			//altre pagine
				...
				pageType='xxx';
/*TODO
	se siamo in altre pagine
		aggiungere pulsanti per 
			sostituire versione libro in inglese -> italiano
...
*/
			...
			console.log(_logPrefix+'Page identified as '+pageType);
